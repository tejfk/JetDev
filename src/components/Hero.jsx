      ...
      <div className="max-w-screen-2xl mx-auto w-full px-6 md:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 flex-grow">
        ...
        >
          ...
          >
            <div className="flex">
              <a
                href="https://github.com/tejfk"
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full border-2 border-bg-primary bg-white/10 backdrop-blur-md flex items-center justify-center hover:bg-white/20 hover:border-white transition-all duration-300"
                aria-label="GitHub"
              >
